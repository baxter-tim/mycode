...
def index():
  ...
  if "username" in session:
    ...
    age = session["age"]
    return f"Logged in as {username} and your striding at {age} <br><b><a href = '/logout'>click here to log out</a></b>"
...
def login():
   ...
   if request.method == "POST":
      ...
      session["age"] = request.form.get("age") ## added for age
   ...
   <form action = "" method = "post">
      ...
      <p><input type = text name = age></p>  ## added for age
